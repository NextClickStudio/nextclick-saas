...
// Global CORS — MUST come before routes.
// The widget runs on a Shopify storefront (different origin), so every
// /api/* endpoint needs permissive CORS headers.
app.use(cors({
  origin: '*',
  methods: ['GET', 'POST', 'DELETE', 'OPTIONS'],
  allowedHeaders: ['Content-Type', 'Authorization'],
  credentials: false   // credentials:true is incompatible with origin:'*'
}));
