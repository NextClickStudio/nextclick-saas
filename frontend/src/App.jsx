...
function AppContent() {
  ...
  // If we get 401 from the backend, redirect to re-auth
...
export default function App() {
  ...
  // AppBridgeProvider is separate from AppProvider in Polaris v13
  // AppProvider no longer accepts appBridgeConfig
  return (
    <AppBridgeProvider
      config={{
        apiKey,
