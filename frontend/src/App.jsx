...
// ✅ FIX: safe redirect that works inside Shopify iframe
function redirectToAuth(shopParam) {
  const authUrl = '/api/auth?shop=' + shopParam;
  try {
    // Inside Shopify embedded app — can't access window.top cross-origin
    // Use postMessage to ask the Shopify admin shell to navigate
    ...
    // Fallback: just redirect this frame
    window.location.href = authUrl;
  }
}
