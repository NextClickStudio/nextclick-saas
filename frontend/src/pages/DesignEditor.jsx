...
export function DesignEditor() {
  ...
  return (
    <Page
      ...
      secondaryActions={[{ content: '👁️ Anteprima widget', onAction: () => (window.top || window).open(`${import.meta.env.VITE_HOST || 'https://nextclick-saas-production.up.railway.app'}/widget?shop=${shop?.shopDomain || ''}`, '_blank') }]}
    >
      <BlockStack gap="500">
