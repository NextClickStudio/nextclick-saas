...
const STYLE_PRESETS = [
  {
    ...
    values: { primaryColor: '#0A0A0A', secondaryColor: '#C8A96E', bgColor: '#FAFAF8', textColor: '#0A0A0A', subtitleColor: '#6B6B6B', buttonColor: '#0A0A0A', buttonTextColor: '#FFFFFF', borderRadius: '0px', fontFamily: 'Cormorant Garamond' },
  },
  {
    label: '🌿 Natural Green',
    values: { primaryColor: '#2D5016', secondaryColor: '#7BAE37', bgColor: '#F5F7F2', textColor: '#1A2E0A', subtitleColor: '#5A7040', buttonColor: '#2D5016', buttonTextColor: '#FFFFFF', borderRadius: '8px', fontFamily: 'Fraunces' },
  },
  {
    label: '🌸 Soft Blush',
    values: { primaryColor: '#2C1810', secondaryColor: '#E8A598', bgColor: '#FDF6F5', textColor: '#2C1810', subtitleColor: '#9B7570', buttonColor: '#C4756A', buttonTextColor: '#FFFFFF', borderRadius: '12px', fontFamily: 'Playfair Display' },
  },
  {
    label: '🌊 Ocean Blue',
    values: { primaryColor: '#0D2B45', secondaryColor: '#2A9D8F', bgColor: '#F0F7FA', textColor: '#0D2B45', subtitleColor: '#4A7090', buttonColor: '#0D2B45', buttonTextColor: '#FFFFFF', borderRadius: '6px', fontFamily: 'DM Sans' },
  },
  {
    label: '⬜ Minimal White',
    values: { primaryColor: '#111111', secondaryColor: '#888888', bgColor: '#FFFFFF', textColor: '#111111', subtitleColor: '#888888', buttonColor: '#111111', buttonTextColor: '#FFFFFF', borderRadius: '4px', fontFamily: 'Syne' },
  },
  {
    label: '🖤 Midnight Premium',
    values: { primaryColor: '#F5F0E8', secondaryColor: '#D4AF7A', bgColor: '#0A0A0A', textColor: '#F5F0E8', subtitleColor: '#A09880', buttonColor: '#D4AF7A', buttonTextColor: '#0A0A0A', borderRadius: '2px', fontFamily: 'Cormorant Garamond' },
  },
];
...
const COLOR_FIELDS = [
  ...
  { key: 'subtitleColor',   label: 'Subtitle / muted',desc: 'Hero subtitle, secondary labels and muted text' },
