...
import {
  ...
  TextField, Select, Button, Banner, Toast, Frame
          ...
          <BlockStack gap="400">
            ...
            <Card>
              <BlockStack gap="300">
                ...
                />
                <div style={{ fontFamily: config.fontFamily, fontSize: 18, padding: '8px 0', color: config.textColor, background: config.bgColor, borderRadius: 6, padding: 12 }}>
