      ...
      <BlockStack gap="500">
        ...
        <Card>
          <BlockStack gap="300">
            ...
            <InlineStack gap="300">
              ...
              <Button onClick={() => (window.top || window).open(widgetPreview, '_blank')} variant="secondary">
                👁️ Apri anteprima
              </Button>
            </InlineStack>
            <Banner tone="info">
        ...
        <Card>
          <BlockStack gap="300">
            ...
            <Button onClick={() => (window.top || window).open(widgetPreview, '_blank')} variant="primary">
              🚀 Testa il widget ora
            </Button>
          </BlockStack>
        </Card>
