...
export function WidgetPage() {
  ...
  // Usa la variabile d'ambiente VITE_HOST oppure il dominio attuale del backend
  // Poiché siamo in un iframe Shopify, non possiamo usare window.location
      ...
      <BlockStack gap="500">
        ...
        <Card>
          <BlockStack gap="300">
            ...
            <Text tone="subdued">
              Puoi linkare direttamente al widget come pagina intera.
            </Text>
