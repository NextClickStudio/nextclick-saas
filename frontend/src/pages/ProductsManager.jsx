...
export function ProductsManager() {
  ...
  return (
    <Page
      ...
      secondaryActions={[{ content: syncing ? 'Sincronizzando...' : '🔄 Sincronizza da Shopify', onAction: handleSync, loading: syncing }, { content: '🔗 Import from URLs', onAction: openImport }]}
    >
      <BlockStack gap="400">
        ...
        <Banner tone="info">
          <p>Add products manually or use <strong>Import from URLs</strong> — paste product page links and AI will automatically extract title, price, description, and tags.</p>
        </Banner>
          ...
          {loading
            ...
            : rows.length > 0
              ? <DataTable
                  ...
                  headings={['Product','Price','Category','Status','Actions']}
                  rows={rows}
              ...
              : <div style={{ textAlign: 'center', padding: 40 }}>
                  <BlockStack gap="300" inlineAlign="center">
                    ...
                    <InlineStack gap="200">
                      <Button variant="primary" onClick={openNew}>+ Add manually</Button>
                      <Button onClick={openImport}>🔗 Import from URLs</Button>
                    </InlineStack>
                  </BlockStack>
                </div>
          }
