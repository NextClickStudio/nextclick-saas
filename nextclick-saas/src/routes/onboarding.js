...
document.querySelector('.cat-card').classList.add('selected');
document.querySelector('.cat-card input').checked=true;
</script>
</body></html>`;
}
...
<div class="wrap">
  ...
  <p class="sub">Personalizza i colori e il font del tuo AI Advisor.<br>Useranno i colori del tuo brand.</p>
