...
// Strip trailing slash — a common Railway misconfiguration
...
const shopify = shopifyApi({
  ...
  // IMPORTANT: scopes here must exactly match what is configured in
  // Shopify Partner Dashboard → App setup → API scopes
...
app.get('/widget', (req, res) => {
  ...
  // Replace ALL occurrences of %%API_HOST%%
...
app.get('/health', (_req, res) => res.json({ status: 'ok', host: HOST, ts: new Date().toISOString() }));
